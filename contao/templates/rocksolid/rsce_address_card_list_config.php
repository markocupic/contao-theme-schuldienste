...
return [
    'label'           => [
        'de' => [
            'Addresskarten-Liste',
            'Fügen Sie dem Artikel eine Addresskarten-Liste hinzu mit, Name, Addresse, Telefonnummer und E-Mail-Adresse',
        ],
        'en' => [
            'Address card list',
            'Add an address card list to the article including name, address, phone number and email address',
        ],
    ],
    'types'           => ['content'],
    ...
    'fields'          => [
        ...
        'cards' => [
            'label'        => [
                'de' => [
                    'Addresskarten',
                    'Fügen Sie eine beliebige Anzahl an Addresskarten ein.',
                ],
                'en' => [
                    'Address cards',
                    'Insert any number of address cards.',
                ],
            ],
            'elementLabel' => [
                'de' => 'Karte %s',
